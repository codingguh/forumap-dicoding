  ...
  return (
    <div role="button" tabIndex={0} className="talk-item" onClick={onThreadClick} onKeyDown={onThreadPress}>
      ...
      <div className="talk-item__detail">
        ...
        <article>
          <h1 style={{
            border: '1px solid black', width: 'fit-content', padding: '3px 6px', fontSize: '14px', borderRadius: '12px',
          }}
          >
            #
            {category}
          ...
          <p className="talk-item__text">{parse(body)}</p>
        </article>

        {
          like && (
            <div className="talk-item__likes" style={{ display: 'flex', gap: '12px' }}>
              <p>
